...
import parseLinkeHeader from 'parse-link-header';
...
export class Home extends Component {
    constructor(props) {
        ...
        this.getPosts = this.getPosts.bind();
        this.createNewPost = this.createNewPost.bind();
    }
        ...
        API.fetchPosts(this.state.endpoint)
            .then(res => {
                return res.json().then(posts => {
                    const links = parseLinkeHeader(res.headers.get('Link'));
                    this.setState(() => ({
